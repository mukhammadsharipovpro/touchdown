...
import {seafoodAppetizers} from '../assets/products';

const TouchDownTabCartItemComponent = ({item}) => {
  ...
  const productImage = seafoodAppetizers.find(p => p.name === item.name)?.image;
...
export default TouchDownTabCartItemComponent;
