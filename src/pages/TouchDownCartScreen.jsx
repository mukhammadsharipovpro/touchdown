...
import TouchDownTabCartItemComponent from '../components/TouchDownTabCartItemComponent';
        ...
        <>
          <View style={{height: height * 0.7}}>
            <ScrollView style={styles.flex} contentContainerStyle={styles.main}>
              {cart.map((item, index) => (
                <TouchDownTabCartItemComponent item={item} key={index} />
              ))}
            </ScrollView>
          </View>
        </>
